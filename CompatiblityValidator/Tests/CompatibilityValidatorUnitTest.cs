...
namespace Tools
{
    ...
    public class CompabilityValidatorUnitTest
    {
        ...
        private class TestProvider : ProviderBase
        {
            ...
            public override Task<Resource> Create(Resource resource, string correlationIdentifier)
            {
            ...
            public override Task<Resource[]> Query(IQueryParameters parameters, string correlationIdentifier)
            {
                Resource[] resources = 
                    new Resource[] 
                    { 
